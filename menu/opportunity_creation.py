...
def BuildOpportunityCreation(avaregeOpportunityCreatedMonth, avaregeOpportunityCreatedYear):
    ...
    component_plot_DualAxis_Chart(avaregeOpportunityCreatedMonth, x_col='Mes/Ano', y_col_bar='Oportunidades', y_col_line='Media em DIAS', name='Total de Oportunidades com Média de Criação', height="440px", width="1300px")
